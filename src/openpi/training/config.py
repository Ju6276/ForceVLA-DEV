...
class LeRobotLiberoDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        print("-"*100)
        print("libero data is loading..")
        print("assets_dirs is: {}".format(assets_dirs))
        print("-"*100)
...
_CONFIGS = [
    ...
    TrainConfig(
        name="forcevla_button_native_instantaneous_100hz",
        project_name="forcevla",
        model=pi0_force.Pi0_GuidanceConfig(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            force_encoder=force_encoder.ForceEncoderConfig(
                type="native_instantaneous",
        ...
        data=LeRobotForcevlaDataConfig(
            repo_id="panda_button_press",
            # Reuse the Temporal experiment's training-only statistics so the
            # latest-sample and TCN inputs have exactly the same normalization.
            assets=AssetsConfig(
    ...
    TrainConfig(
        name="forcevla_button_native_instantaneous_100hz_val",
        project_name="forcevla",
        model=pi0_force.Pi0_GuidanceConfig(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
